def contribution_alt1(neuron):
    """
    An alternate version of the update rule based on the value of the delay functions. lets weights go to 0.
    should be faster.
    ...
    for input_ in neuron.inputs_and_variables:
        if neuron.inputs_and_variables[input_].value - neuron.options['variable_rate'] >= 0:
            ...
            neuron.inputs_and_variables[input_].value = 0
