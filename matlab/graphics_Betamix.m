function graphics_Betamix(betamix,savehere,delaywin,F,format)

delaywin=delaywin*1000; % convert to ms

t=linspace(0,delaywin,size(betamix,2));

figure('color',[1 1 1],'position',[0 0 2560 1389],'visible','off');
% Generate a contour plot
subplot(1,2,1)
contourf(betamix,'xdata',t,'ydata',F,'LineWidth',5)
...
%    'LineWidth', 5);
surf(betamix,'xdata',t,'ydata',F, 'facelighting','gouraud', ...
...
export_fig([savehere '-wmesh' '.' format], ['-' format])
